...
MODELS : ModelSet =\
{
	'codeformer':
	{
		...
		'path': resolve_relative_path('../faceswap_pack/codeformer.onnx'),
		'template': 'ffhq_512',
		'size': (512, 512)
	},
	'gfpgan_1.2':
	{
		...
		'path': resolve_relative_path('../faceswap_pack/gfpgan_1.2.onnx'),
		'template': 'ffhq_512',
		'size': (512, 512)
	},
	'gfpgan_1.3':
	{
		...
		'path': resolve_relative_path('../faceswap_pack/gfpgan_1.3.onnx'),
		'template': 'ffhq_512',
		'size': (512, 512)
	},
	'gfpgan_1.4':
	{
		...
		'path': resolve_relative_path('../faceswap_pack/gfpgan_1.4.onnx'),
		'template': 'ffhq_512',
		'size': (512, 512)
	},
	'gpen_bfr_256':
	{
		...
		'path': resolve_relative_path('../faceswap_pack/gpen_bfr_256.onnx'),
	...
	'gpen_bfr_512':
	{
		...
		'path': resolve_relative_path('../faceswap_pack/gpen_bfr_512.onnx'),
		'template': 'ffhq_512',
		'size': (512, 512)
	},
	'restoreformer':
	{
		...
		'path': resolve_relative_path('../faceswap_pack/restoreformer.onnx'),
		'template': 'ffhq_512',
		'size': (512, 512)
	}
}
