...
MODELS : ModelSet =\
{
	'face_detector_retinaface':
	{
		...
		'path': resolve_relative_path('../faceswap_pack/retinaface_10g.onnx')
	},
	'face_detector_yunet':
	{
		'url': 'https://github.com/facefusion/facefusion-assets/releases/download/models/yunet_2023mar.onnx',
		'path': resolve_relative_path('../faceswap_pack/yunet_2023mar.onnx')
	},
	'face_recognizer_arcface_blendswap':
	{
		...
		'path': resolve_relative_path('../faceswap_pack/arcface_w600k_r50.onnx')
	},
	...
	'face_recognizer_arcface_simswap':
	{
		...
		'path': resolve_relative_path('../faceswap_pack/arcface_simswap.onnx')
	},
	'gender_age':
	{
		'url': 'https://github.com/facefusion/facefusion-assets/releases/download/models/gender_age.onnx',
		'path': resolve_relative_path('../faceswap_pack/gender_age.onnx')
	}
}
